...
public class CommonConst {
     ...
     * 默认头像
     */
    public static final String DEFAULT_AVATAR = "https://static.ve77.cn/avatar/tiger.jpg";
    /**
     * 默认简介
     */
    public static final String DEFAULT_INTRO = "该用户还没有添加简介";
}
