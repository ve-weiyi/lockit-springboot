...
public class UserAuthController {
    ...
    /**
     * 用户注册
     * @RequestBody 注解时，前端必须且只能传一个对象JSON过来
     * @param user 用户信息
     * @return {@link Result<>}
     */
    ...
    public Result<?> register(@Valid  UserVO user) {
    ...
    public Result<LoginVO> login(@Valid UserVO user) {
    ...
    public Result<LoginVO> weiboLogin(@Valid @RequestBody WeiboLoginVO weiBoLoginVO) {
